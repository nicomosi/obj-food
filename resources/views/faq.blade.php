                    ...
                    <div class="panel panel-default mt-4">
                        ...
                        <div class="panel-body">
                            <div class="theme-accordion-container">
                                ...
                                <div class="theme-accordion">
                                    <div class="theme-accordion-hdr">
                                        <h4 class="text-primary"><span class="icon-question"></span> Question 3 Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
                                        <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                    </div>
                                    <div class="theme-accordion-bdy">
                                        <div class="row p-3">
                                ...
                                <div class="theme-accordion">
                                    <div class="theme-accordion-hdr">
                                        <h4 class="text-primary"><span class="icon-question"></span>Question 4 Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
                                        <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                    </div>
                                    <div class="theme-accordion-bdy">
                                        <div class="row p-3">
                                ...
                                <div class="theme-accordion">
                                    <div class="theme-accordion-hdr">
                                        <h4 class="text-primary"><span class="icon-question"></span>  Question 5 Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
                                        <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                    </div>
                                    <div class="theme-accordion-bdy">
                                        <div class="row p-3">
                                ...
                                <div class="theme-accordion">
                                    <div class="theme-accordion-hdr">
                                        <h4 class="text-primary"><span class="icon-question"></span> Question 6 Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
                                        <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                    </div>
                                    <div class="theme-accordion-bdy">
                                        <div class="row p-3">
